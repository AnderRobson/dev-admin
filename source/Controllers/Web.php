...
class Web extends Controller
{
    ...
    /**
     * Responsavel por desconectar usu�rio
     */
    public function logoff(): void
    {
        flash("success", "Voc� saiu com sucesso, volte logo {$this->user->getUser()->getFullName()}!");
        $this->user->destruct();
    ...
    /**
     * Responsavel por tratar rota de recupera��o de senha
     *
     * @param array $data
     */
