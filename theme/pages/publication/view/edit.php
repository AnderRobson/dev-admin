...
$v->layout("publication/view/_theme"); ?>
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="row">
            <div class="card">
                <img src="<?= urlFile("upload/publication" . DS . $publication->image, true); ?>" class="card-img-top" alt="<?= $publication->title; ?>">
                <div class="card-footer">
                    <small class="text-muted">Imagem cadastrado em: <?= $publication->created_at; ?></small>
                    <a href="#" data-action="<?= url("pages/publication/delete_image"); ?>" data-id="<?= $publication->id; ?>">
                        <button type="button" class="btn btn-danger float-right">
                            Deletar Imagem
                        </button>
                    </a>
